<div class="collapse hide my-3 p-4 rounded bg-secondary bg-opacity-10" id="showEditItem{{ $item_id }}" wire:ignore.self>
    <form class="container" wire:submit.prevent="editItem">
        <div class="row">
